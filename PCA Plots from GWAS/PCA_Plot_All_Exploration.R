...
pca_data <- read.table("2run_all_missense_added_pheno_filt_added_sex_pca.eigenvec", header = FALSE, stringsAsFactors = FALSE)
...
ggsave("all_plot1.jpeg", width = 6, height = 4, dpi = 600)
...
ggsave("all_plot2.jpeg", width = 6, height = 4, dpi = 600 )
...
ggsave("all_plot3.jpeg", width = 6, height = 4, dpi = 600 )
...
# Read the eigenvec file
pca_data <- read.table("2run_all_missense_added_sex_filt_pca_male.eigenvec", header = FALSE, stringsAsFactors = FALSE)
...
ggsave("all_plot4.jpeg", width = 6, height = 4, dpi = 600 )
...
ggplot(pca_merged, aes(x = Treatment, y = PC1, fill = Treatment)) +
  ...
  theme_minimal() +
  theme(plot.title = element_text(hjust = 0.5, face = "bold"))
ggsave("all_plot5.jpeg", width = 6, height = 4, dpi = 600 )
...
ggsave("all_plot6.jpeg", width = 6, height = 4, dpi = 600 )
...
ggsave("all_plot7.jpeg", width = 6, height = 4, dpi = 600 )
...
ggplot(pca_merged, aes(x = village, y = PC1, fill = village)) +
  ...
  theme_minimal() +
  theme(plot.title = element_text(hjust = 0.5, face = "bold"))
ggsave("all_plot8.jpeg", width = 6, height = 4, dpi = 600 )
...
ggsave("all_plot9.jpeg", width = 6, height = 4, dpi = 600 )
...
# Read the eigenvec file
pca_data <- read.table("2run_all_missense_added_sex_filt_pca.eigenvec", header = FALSE, stringsAsFactors = FALSE)
...
ggsave("all_plot10.jpeg", width = 6, height = 4, dpi = 600 )
...
ggsave("all_plot11.jpeg", width = 6, height = 4, dpi = 600 )
...
ggsave("all_plot12.jpeg", width = 6, height = 4, dpi = 600 )
...
ggsave("all_plot13.jpeg", width = 6, height = 4, dpi = 600 )
...
ggplot(pca_merged, aes(x = village, y = PC1, fill = village)) +
  ...
  ylim(-0.01, 0.01) +
  theme(plot.title = element_text(hjust = 0.5, face = "bold"))
ggsave("all_plot14.jpeg", width = 6, height = 4, dpi = 600 )
...
ggsave("all_plot15.jpeg", width = 6, height = 4, dpi = 600 )
